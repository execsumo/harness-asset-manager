...
const englishHooksCopy = {
  inUse: {
    ...
    uninstall: {
      ...
      description: "Remove this hook from harness-asset-manager and disable it on all harnesses.",
      singleDescription: "Remove this hook from harness-asset-manager and disable it on all harnesses.",
      pending: "Deleting",
  ...
  detail: {
    ...
    matrix: {
      ...
      foundTooltip: (harness: string) => `Configured outside harness-asset-manager on ${harness}`,
