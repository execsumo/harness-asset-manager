...
const hooks = vi.hoisted(() => ({
  ...
  onMultiSelectEnableHarness: vi.fn(async () => undefined),
  onMultiSelectDisableHarness: vi.fn(async () => undefined),
  onMultiSelectDelete: vi.fn(async () => undefined),
  onMultiSelectStar: vi.fn(async () => undefined),
  onMultiSelectTag: vi.fn(async () => undefined),
  onMultiSelectAgent: vi.fn(async () => undefined),
  onConfirmAttachAgents: vi.fn(async () => undefined),
  onCancelAttachAgents: vi.fn(),
  onToggleStar: vi.fn(async () => undefined),
...
vi.mock("../model/use-skills-workspace-controller", () => ({
  useSkillsWorkspaceController: () => ({
    context: {
      ...
      onMultiSelectEnableHarness: hooks.onMultiSelectEnableHarness,
      onMultiSelectDisableHarness: hooks.onMultiSelectDisableHarness,
      onMultiSelectDelete: hooks.onMultiSelectDelete,
      onMultiSelectStar: hooks.onMultiSelectStar,
      onMultiSelectTag: hooks.onMultiSelectTag,
      onMultiSelectAgent: hooks.onMultiSelectAgent,
      attachAgentsState: null,
      onConfirmAttachAgents: hooks.onConfirmAttachAgents,
      onCancelAttachAgents: hooks.onCancelAttachAgents,
      onToggleStar: hooks.onToggleStar,
