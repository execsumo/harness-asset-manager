...
MCP_REGISTRY_BASE_URL_ENV = _shared.MCP_REGISTRY_BASE_URL_ENV
_TIMEOUT_SECONDS = 15
...
def configured_mcp_registry_base_url(env: dict[str, str] | None = None) -> str:
    ...
    configured = (_shared.env_get(active_env, MCP_REGISTRY_BASE_URL_ENV) or DEFAULT_MCP_REGISTRY_BASE_URL).strip()
