...
class ReleaseTargetTests(unittest.TestCase):
    def test_resolves_darwin_arm64_aliases(self) -> None:
        ...
        self.assertEqual(artifact_name("1.2.3", target), "harness-asset-manager-v1.2.3-darwin-arm64.tar.gz")
    ...
    def test_resolves_linux_arm64_aliases(self) -> None:
        ...
        self.assertEqual(artifact_name("1.2.3", target), "harness-asset-manager-v1.2.3-linux-arm64.tar.gz")
